...
JNE 0, 2, 29	# Check if it's a sentence.
AIR 0, 13		# Output a '\n'
OUT 0, 1				
LDR 0, 1, 30	# Update sentence count
SIR 0, 1		# Update sentence count
STR 0, 1, 30	# Update sentence count
RFS 1			# Is a sentence, sentence count updated, #29
RFS 0			# Not a sentence, #30
0				# Reserved for page ending 0
0				# Reserved
0				# Reserved
0				# Reserved
